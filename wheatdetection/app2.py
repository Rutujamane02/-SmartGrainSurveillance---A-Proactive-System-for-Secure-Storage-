...
# Uncomment the next two lines if you plan to use a .env file
# from dotenv import load_dotenv
# load_dotenv()

# Retrieve the API key from the environment variable
api_key = os.getenv("ROBOFLOW_API_KEY")  # Corrected variable name
if not api_key:
...
project = rf.workspace().project("keede")  # Replace with your project name
